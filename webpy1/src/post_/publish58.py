...
class browser():
    def __init__(self,ppms):
        ...
        self.title=""
        self.xiaoqu=""
        self.content="<SPAN id=comp-paste-div-700><SPAN id=comp-paste-div-700>闸北新立小区花园整间出租</SPAN></SPAN>"
        self.MinPrice="面议"
        self.area="43"
        self.jushishuru="1"
        self.huxingting="1"
    ...
    def porcessGetParams(self):
        ...
        self.citycode=self.ppms["citycode"]
...
if __name__=="__main__":
    ...
    "house_floor":"2",
    "house_age":"10",
    "house_desc":'''<SPAN id=comp-paste-div-700>物业费，次价格物业费，次价格物业费，次价格物业费，次价格</SPAN>''',
    "borough_id":"10",
    "borough_name":"秀水苑ii",
    "house_drawing":"",
    "house_thumb":"",
