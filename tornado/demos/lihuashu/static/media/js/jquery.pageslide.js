...
(function($) {
    ...
    var _sliding = false,
        // Mutex to assist closing only once
    ...
    $.fn.pageslide.defaults = {
        ...
        modal: false,
        // If set to true, you must explicitly close pageslide using $.pageslide.close();
        iframe: true,
        // By default, linked pages are loaded into an iframe. Set this to false if you don't want an iframe.
