...
class startCityThread(threading.Thread):
    ...
    def run(self):
        ...
        t581=threading.Thread(target=soufun.getLinks, args=(args581,))
        t582=threading.Thread(target=soufun.getLinks, args=(args582,))
        t583=threading.Thread(target=soufun.getLinks, args=(args583,))
        t584=threading.Thread(target=soufun.getLinks, args=(args584,))
        t581.start()
        t582.start()
        t583.start()
        t584.start()
